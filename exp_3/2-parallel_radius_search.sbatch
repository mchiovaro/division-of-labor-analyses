...
#SBATCH --job-name=slurm_exp_3                # Name of job
...
#SBATCH --output=slurm_output/out_exp_3.out   # Output file
#SBATCH --error=slurm_output/err_exp_3.err    # Error file
#SBATCH --array=1-204                         # Number of times we want to run the file (dyad-round-radius combos; observations in radius_grid_search in R script)
